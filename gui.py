...
class GUI(QWidget):
    def __init__(self, service):
        ...
        self.__len_rows = service.getNumberOfRows()
        self.__len_cols = service.getNumberOfCols()
        self.__matrixButtons = [[0 for _ in range(self.__len_cols)] for _ in range(self.__len_rows)]
        self.__visitedButtons = [[0 for _ in range(self.__len_cols)] for _ in range(self.__len_rows)]
    ...
    def __onClickButton(self):
        ...
        if lst == BOMB:
            ...
            result = QMessageBox.information(self, 'you have lost', 'you have lost', QMessageBox.Close | QMessageBox.Retry)
    ...
    def __applyBFSonMultipleSquares(self, listOfSquares, row, col):
        for sq in listOfSquares:
            lst = self.__service.bfsOnBoard(sq.get_row, sq.get_col)
            if lst == BOMB:
                # print('bomb')
                result = QMessageBox.information(self, 'you have lost', 'you have lost',
        ...
        if event.type() == QtCore.QEvent.MouseButtonPress:
            if event.button() == QtCore.Qt.RightButton:
                ...
                if self.__visitedButtons[r][c] == 0:
                    ...
                    self.__applyBFSonMultipleSquares(l, r, c)
